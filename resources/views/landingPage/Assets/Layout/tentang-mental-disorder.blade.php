    ...
    <div class="container-md">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active me-4" href="#">Edukasi</a>
          </li>
          <li class="nav-item">
...
<!-- Main Start -->
<main>
 <!-- Tentang Kesehatan Mental Start -->
 <section class="tentang-mental-disorder" id="">
    <div class="container">
  
      <div class="row">
        <div class="col-md-8">
          <h1>Apa saja Gangguan Mental itu?</h1>

        </div>
        <div class="col-md-6">
          <h2 class="text-start ">1. Gangguan kecemasan</h2>
          <p class="text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur rem expedita id magnam, totam dolore eveniet blanditiis doloremque suscipit quo ad, illum voluptate reprehenderit eligendi cumque error unde, delectus similique voluptatibus incidunt? Rem aliquid hic illo voluptates, enim optio id impedit molestias officiis incidunt accusantium aspernatur deserunt ducimus esse eveniet. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati, odit cupiditate. Enim velit labore veniam assumenda maiores animi delectus optio?</p>
        </div>
        <div class="col-md-6 mb-5">
          <div class="card rounded-15 p-3">
            <img class="seni img-fluid rounded-15 " src="/Assets/Img/Desain-tanpa-judul1.png" alt="">
          </div>
        ...
        <div class="col-md-6 mb-5">
          <div class="card rounded-15 p-3">
            <img class="seni img-fluid rounded-15 " src="/Assets/Img/mood-disorder.png" alt="">
          </div>

        </div>

        <div class="col-md-6">
          <h2 class="text-start ">2.Gangguan Mood</h2>
          <p class="text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur rem expedita id magnam, totam dolore eveniet blanditiis doloremque suscipit quo ad, illum voluptate reprehenderit eligendi cumque error unde, delectus similique voluptatibus incidunt? Rem aliquid hic illo voluptates, enim optio id impedit molestias officiis incidunt accusantium aspernatur deserunt ducimus esse eveniet. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati, odit cupiditate. Enim velit labore veniam assumenda maiores animi delectus optio?</p>
        </div>

        <div class="col-md-6">
          <h2 class="text-start">3. Insecure yang berlebihan </h2>
          <p class="text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur rem expedita id magnam, totam dolore eveniet blanditiis doloremque suscipit quo ad, illum voluptate reprehenderit eligendi cumque error unde, delectus similique voluptatibus incidunt? Rem aliquid hic illo voluptates, enim optio id impedit molestias officiis incidunt accusantium aspernatur deserunt ducimus esse eveniet. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati, odit cupiditate. Enim velit labore veniam assumenda maiores animi delectus optio?</p>
        </div>
        <div class="col-md-6 mb-5">
          <div class="card  p-3">
            <img class="seni img-fluid  " src="/Assets/Img/insecure.png" alt="">
          </div>
        ...
        <div class="col-md-6 mb-5">
          <div class="card  p-3">
            <img class="seni img-fluid" src="/Assets/Img/trauma.png" alt="">
          </div>

        </div>

        <div class="col-md-6">
          <h2 class="text-start ">4. Post Traumatic Stress Disorder atau PTSD </h2>
          <p class="text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur rem expedita id magnam, totam dolore eveniet blanditiis doloremque suscipit quo ad, illum voluptate reprehenderit eligendi cumque error unde, delectus similique voluptatibus incidunt? Rem aliquid hic illo voluptates, enim optio id impedit molestias officiis incidunt accusantium aspernatur deserunt ducimus esse eveniet. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati, odit cupiditate. Enim velit labore veniam assumenda maiores animi delectus optio?</p>
        </div>

        <div class="col-md-6">
          <h2 class="text-start ">5.Gangguan Psikotik</h2>
          <p class="text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur rem expedita id magnam, totam dolore eveniet blanditiis doloremque suscipit quo ad, illum voluptate reprehenderit eligendi cumque error unde, delectus similique voluptatibus incidunt? Rem aliquid hic illo voluptates, enim optio id impedit molestias officiis incidunt accusantium aspernatur deserunt ducimus esse eveniet. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati, odit cupiditate. Enim velit labore veniam assumenda maiores animi delectus optio?</p>
        </div>
        <div class="col-md-6 mb-5">
          <div class="card  p-3">
            <img class="seni img-fluid  " src="/Assets/Img/psikotik.png" alt="">
          </div>
